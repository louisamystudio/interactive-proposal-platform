...
export const CONSTANTS = {
  ...
  EXCEL: {
    ...
    VALIDATION: {
      ...
      contractPrice: 137743.50   // Original Excel contract price
    }
  }
} as const
...
export const CLIENT_OPTIONS = {
  ...
  B: {
    ...
    valuePromise: 'Strategic alliance—we orchestrate your interior designer'
  },
  C: {
    investment: 87_898,
...
export const CORRECTED_BUDGET_CALC = {
  ...
  calculation: `${DR_DE_JESUS_PROJECT.areas.existingAreaFt2} ft² × $${DR_DE_JESUS_PROJECT.costs.remodelTargetPSF}/ft² × ${DR_DE_JESUS_PROJECT.multipliers.remodelMultiplier} = $859,365`,
