-- Database schema for Puerto Rico Construction Cost Index 2025
-- Mirrors supabase/schema.pr_construction_cost_index_2025.sql

create table if not exists pr_construction_cost_index_2025 (
...
on pr_construction_cost_index_2025 (building_use, building_type, category, building_tier);
